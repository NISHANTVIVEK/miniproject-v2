...
public class Application {
	...
	public Application(int app_id, String full_name, String dob, String highest_qualification, int marks, String goals,
			String email, String sch_prog_id, String status, String date_of_interview) {
		super();
		this.app_id = app_id;
